...
class SeleniumTests:
    ...
    def test_about_repolink(self):
        ...
        WebDriverWait(self.driver, 5).until(expected_conditions.visibility_of(link))
        link.click()
        url = self.driver.current_url
        assert url == "https://gitlab.com/johannramirez07/cs373-idb-18"

    def test_about_infobutton(self):
        self.driver.get("https://www.sportsrightnow.me/")
        self.driver.find_element(By.LINK_TEXT, "About").click()
    ...
    def test_navbar_elements(self):
        self.driver.get("https://www.sportsrightnow.me/")
        assert self.driver.find_elements(By.PARTIAL_LINK_TEXT, "Home")
        assert self.driver.find_elements(By.PARTIAL_LINK_TEXT, "About")
        assert self.driver.find_elements(By.PARTIAL_LINK_TEXT, "Players")
        assert self.driver.find_elements(By.PARTIAL_LINK_TEXT, "Teams")
        assert self.driver.find_elements(By.PARTIAL_LINK_TEXT, "Events")

    def test_navbar_home(self):
        self.driver.get("https://www.sportsrightnow.me/somepage")
